  ...
  return (
    <section className="contact-section" id="contact">
      ...
      <motion.div
        ...
        <a href="https://leetcode.com/u/Gudoorumahesh/" target="_blank" rel="noopener noreferrer" className="contact-icon glassdoor">
                              <svg xmlns="http://www.w3.org/2000/svg" width={32} height={32} fill="currentColor" className="bi bi-leetcode" viewBox="0 0 24 24" xmlSpace="preserve">
